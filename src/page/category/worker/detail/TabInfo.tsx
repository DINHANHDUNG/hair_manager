...
const validationSchema = yup.object({
  workerId: yup.string().max(255).required('Trường này là bắt buộc'),
  nanme: yup
    .string()
    .max(255)
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <Grid container spacing={gridSpacingForm}>
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <MyTextField name='workerId' control={control} label='Mã công nhân' errors={errors} variant='outlined' />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6}>
