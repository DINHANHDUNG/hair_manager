...
const PaymentPage = React.memo(() => {
  ...
  const data = {
    columns: [
      ...
      { field: 'methodPayment', headerName: 'Phương thức TT', editable: checkSale, renderEditCell: TextEditCell }, //methodPayment
      { field: 'bankAccount', headerName: 'Tài khoản nhận', editable: checkSale, renderEditCell: TextEditCell }, //bankAccount
      {
        field: 'statusPayment',
